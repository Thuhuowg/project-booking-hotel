...
{{--        <img class="animation__shake" src="https://career.gpo.vn/uploads/images/zkientruc.jpg" alt="AdminLTELogo" height="60" width="60">--}}
        <h3 class="animation__shake" >loading...</h3>
    </div>
    ...
    <aside class=" main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{route('dashboard')}}" class="brand-link justify-content-center ">

            <span class="brand-text font-weight-light ps-3 ">Quản trị</span>
        </a>
...
{{--                                    </a>--}}
                    ...
                    <li class="nav-item">
                        <a href="pages/kanban.html" class="nav-link">
                            <span class="me-3" ><i class="fas fa-users"></i></span>
                            <span>
                                Quản lí thành viên
                            </span>
                        </a>
    ...
    <footer class="col-sm-12 main-footer ml-0">
        <div class="float-right d-none d-sm-inline-block">
            <b>Copyright 2023</b>by Team-11
        </div>
    </footer>

    <aside class="col-sm-12 control-sidebar control-sidebar-dark">
