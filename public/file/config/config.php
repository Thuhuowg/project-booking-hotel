...
| <input type="button" href="../file/dialog.php?field_id=imgField&lang=en_EN&akey=myPrivateKey" value="Files">
...
$config = array(
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | relative path from file folder to upload folder
    |--------------------------------------------------------------------------
    |
    | with final /
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | relative path from file folder to thumbs folder
    |--------------------------------------------------------------------------
    |
    | with final /
    ...
    */
    ...
    | Can be set to custom icon inside file/img
    |
    */
    'icon_theme' => "ico",


    //Show or not total size in file (is possible to greatly increase the calculations)
    'show_total_size'						=> false,
    //Show or not show folder size in list view feature in file (is possible, if there is a large folder, to greatly increase the calculations)
    'show_folder_size'						=> false,
    //Show or not show sorting feature in file
    'show_sorting_bar'						=> true,
    //Show or not show filters button in file
    'show_filter_buttons'                   => true,
    //Show or not language selection feature in file
    ...
    */
    ...
    //*********************
    //  If you insert an extensions blacklist array the file don't check any extensions but simply block the extensions in the list
    ...
    *******************/
    ...
    //file in a folder the javascript script can't sort all or filter all, so the file switch to php script.
    ...
    *******************/
    ...
    // New image resized creation with fixed path from file folder after uploading (thumbnails in fixed mode)
    ...
    //
    'fixed_image_creation'                    => false, //activate or not the creation of one or more image resized with fixed path from file folder
    ...
    */
    ...
    // With Responsive file you can create automatically resized image inside the upload folder, also more than one at a time
    ...
    // Remember text filter after close file for future session
